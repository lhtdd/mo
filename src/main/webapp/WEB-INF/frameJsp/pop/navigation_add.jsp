...
<div id="navigation-add-pop">
	...
	<div class="navigation-add-form">
		<form class="layui-form">
			<div class="layui-form-item" lay-filter="navigation_add_form">
				<label class="layui-form-label">网页标题</label>
				<div class="layui-input-inline">
					<input name="urlName" lay-verify="required" placeholder="例如:淘宝主页"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select name="targetFolder" lay-verify="required" >
