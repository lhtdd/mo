...
public class ValidateUtils {
     ...
     * 车辆识别代号
     */
    private static final String V_VIN = "^[\\w\\/\\+]+$";

    /**
     * 车辆发动机号
     */
    private static final String V_ENGINE_NUM = "^[\\w\\-/\\+\\*\\s\u2E80-\uFE4F—]+$";

    /**
     * 车牌号
     */
    private static final String V_VLP = "^([京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领A-Z0-9]{1}" +
            "[A-Z0-9]{1}([京津沪渝桂蒙宁新藏冀晋辽吉黑苏浙皖赣闽鲁粤鄂湘豫川云贵陕甘青琼])?[A-NP-Z0-9]{1}[A-NP-Z0-9]{3}[A-NP-Z0-9挂学警港澳领试超外]{1}" +
            "([A-NP-Z0-9外])?(_(O|1|2|3|4|5|6|9))?)|([A-Z0-9]{7}_(0|1|2|3|4|5|6|9))$";

    /**
     * 座机+手机
     */
    private static final String V_MOBILE_PHONE = "^0[1-9][0-9]{1,2}-[1-9][0-9]{5,7}(-[0-9]{1,4})?|1[3|4|5|7|8|9][0-9]{9}$";

    /**
     * 护照、港澳居民来往内地通行证、台湾居民来往大陆通行证、统一社会信用代码证书、组织机构代码证、营业执照、律师事务所执业许可证
     */
    private static final String V_MIXED_CARD = "^[\\w()\\-（）—/]+$";

    /**
     * 武警、军官证、事业单位法人证书、社会团体法
     */
    private static final String V_MIXED_POLICE = "^[\\u2E80-\\uFE4F\\w\\-—]+$";/**

     /**
     * 行驶证注册日期校验
     */
    private static final String V_DATE_STYLE = "^[0-9]{4}\\-[0-9]{2}\\-[0-9]{2}$";
     ...
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean letterI(String value) {
     ...
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean letterU(String value) {
     ...
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean ascll(String value) {
     ...
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean numberLength(String value) {
     ...
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean vin(String value) {
        return match(V_VIN, value);
    }
     ...
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean engineNum(String value) {
        return match(V_ENGINE_NUM, value);
    }
     ...
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean vlp(String value) {
        return match(V_VLP, value);
    }
     ...
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean mobileAndPhone(String value) {
        return match(V_MOBILE_PHONE, value);
    }

    /**
     * 验证护照、港澳居民来往内地通行证、台湾居民来往大陆通行证、统一社会信用代码证书、组织机构代码证、营业执照、律师事务所执业许可证
     *
     * @param value 要验证的字符串
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean mixedCard(String value) {
        return match(V_MIXED_CARD, value);
    }

    /**
     * 验证武警、军官证、事业单位法人证书、社会团体法
     *
     * @param value 要验证的字符串
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean mixedPolice(String value) {
        return match(V_MIXED_POLICE, value);
    }

    /**
     * 验证行驶证上的日期 例如 2017-02-02
     *
     * @param value 要验证的字符串
     * @return 如果是符合格式的字符串, 返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean carDateStyle(String value) {
        return match(V_DATE_STYLE, value);
    }
